      ...
      <div className={styles.container}>
        ...
        <div>
          ...
          <p className={styles.textDescription}>
            ...
            diam amet diam <br /> et eos. Clita erat ipsum et lorem et sit, sed
            stet lorem sit clita duo justo magna
            <br /> dolore erat amet
          </p>
          <div className={styles.iconText}>
            <img className={styles.icon} src={check}></img>
            <p className={styles.textDescription1}>
      ...
      <div className={styles.bannerBottom}>
        <div className={styles.bannerItem}>
          ...
          <p className={styles.textDescriptionBanner}>
            Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu
            diam amet diam et eos. Clita erat <br /> ipsum et lorem et sit, sed
            stet lorem sit clita duo justo magna dolore erat amet. Diam dolor{" "}
            <br /> diam ipsum sit. Aliqu diam amet diam et eos.
          </p>
        </div>
        <div className={styles.bannerItemButton}>
          <Button className={styles.buttonBanner} type="danger">
