    ...
    <div>
      <div className={styles.textBanner}>
        ...
        <p className={styles.textDescription}>
          Tempor ut dolore lorem kasd vero ipsum sit eirmod sit. Ipsum <br />{" "}
      ...
      <div className={styles.body}>
        ...
        <div className={styles.bodyContactRight}>
          <div>
            <p className={styles.textContactRight}>
              The contact form is currently inactive. Get a functional and
              working contact form with Ajax & PHP <br /> in a few minutes. Just
              copy and paste the files, add a little code and youre done.
              Download Now.
            </p>
            <Input
              className={styles.textContactInput}
              style={{
                width: "350px",
                height: "58px",
          ...
          <Button type="primary" className={styles.bodyContactButton}>
