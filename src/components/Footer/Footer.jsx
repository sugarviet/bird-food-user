        ...
        <AntdFooter>
          <Row gutter={24}>
            <Col span={6} className={styles.spacing}>
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, et omnis fugit ea praesentium perferendis assumenda cupiditate laudantium aspernatur repudiandae blanditiis, quaerat quam aut esse est rem sit reiciendis distinctio.</p>
              <Row>
                <Col span={6}>
            ...
            <Col span={6} className={styles.spacing}> 
              <h1>Newsletter</h1>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio, modi? Quam corrupti quod, laborum officia 
              </p>
              <Input placeholder="Email"/></Col>
          </Row>
          <Row>
            <Col span={24}>
